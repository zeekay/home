...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ...
    data-menu-item
    className={cn(
      "relative flex cursor-default select-none items-center rounded-md px-2 py-1.5 text-sm outline-none focus:bg-blue-500/80 focus:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      inset && "pl-8",
      className
    )}
    {...props}
