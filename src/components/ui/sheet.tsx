...
const sheetVariants = cva(
  "fixed z-50 gap-4 p-6 transition ease-in-out vibrancy-sheet text-white/90 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
