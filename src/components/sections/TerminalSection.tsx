...
const TerminalSection: React.FC<TerminalSectionProps> = ({ activeSection }) => {
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-6 flex items-center justify-center animate-slide-down">
        <span className="terminal-text mr-2">$</span> Interactive Terminal
      </h2>
      
      <Terminal className="animate-scale-in mx-auto" />
      
      <div className="mt-6 text-sm text-muted-foreground animate-fade-in text-center">
