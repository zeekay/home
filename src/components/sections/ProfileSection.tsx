  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center min-h-[60vh] mb-16">
        <div className="w-48 h-48 bg-gradient-to-br from-primary/20 to-primary/40 rounded-full flex items-center justify-center overflow-hidden animate-float border-2 border-primary/20 shadow-lg mb-8">
          <User size={96} className="text-primary/70" />
        </div>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold animate-slide-up bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70 text-center" style={{ animationDelay: '100ms' }}>
          Zach Kelling
        </h1>
        <p className="text-xl md:text-2xl text-muted-foreground animate-slide-up max-w-2xl text-center mt-4" style={{ animationDelay: '200ms' }}>
      ...
      <div className={cn(
        ...
        <div className="glass-card rounded-xl p-8 mb-10 animate-slide-in overflow-hidden">
