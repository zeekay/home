...
export const professionalInfo = {
  ...
  tagline: 'Move in shadow. Build in silence. Ship what matters.',
  roles: [
  ...
  bio: 'Left Topeka at 13 for computers. Spent a decade as a musician. Cypherpunk since the dial-up era. 1000+ OSS repos. Founded Hanzo (Techstars \'17). Post-quantum cryptography, decentralized AI, sovereign infrastructure. The supreme art is to win without fighting — so we build the infrastructure everyone has to use.',
  email: 'z@hanzo.ai',
