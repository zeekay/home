...
export const professionalInfo = {
  ...
  bio: 'Grew up in Topeka, KS. Left for computers at 13. Spent a decade as a professional musician. Came back to tech in the 2000s and never stopped. Cypherpunk since the 90s. Built commerce.js, shop.js, checkout.js, coin.js. Founded Hanzo (Techstars \'17). Building applied cryptography (CGGMP21, ML-KEM, Poseidon2), Lux blockchain, Zen models, and AI + crypto infrastructure for economic sovereignty.',
  email: 'z@hanzo.ai',
